#Thomas Lawless CIS261 ProjectPart2
def GetEmpName():
...
def printinfo(EmpDetailList):
    ...
    for EmpList in EmpDetailList:
        ...
        EmpTotals["DictTotHours"] = TotHours
        EmpTotals["DictTotGrossPay"] = TotGrossPay
        EmpTotals["DictTotTax"] = TotTax
        EmpTotals["DictTotNetPay"] = TotNetPay 
# COMMENT OUT THE FOLLOWING CODE
...
def PrintTotals(EmpTotals):    
    ...
    print(f'Total Hours Worked: {EmpTotals["DictTotHours"]:,.2f}')
    print(f'Total Gross Pay: {EmpTotals["DictTotGrossPay"]:,.2f}')
    print(f'Total Income Tax: {EmpTotals["DictTotTax"]:,.2f}')
    print(f'Total Net Pay: {EmpTotals["DictTotNetPay"]:,.2f}')
